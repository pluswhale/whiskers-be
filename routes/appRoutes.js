...
router.post('/plinko/points/increment/:userId', plinkoControllers.incrementBalance);
router.post('/plinko/points/decrement/:userId', plinkoControllers.decrementBalance);
